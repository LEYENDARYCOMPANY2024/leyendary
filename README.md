...
| 2.1 | Autenticación de dos factores     | Diego                       | Seguridad adicional mediante autenticación de dos factores para el inicio de sesión.                              | Compleja   |
| 3   | Registro de profesores           | Jonathan                    | Proceso para registrar nuevos profesores en la plataforma.                                                        | Compleja   |
| 3.1 | Verificación de identidad        | Diego y Alexis              | Proceso para verificar la identidad de los profesores durante el registro.                                        | Compleja   |
