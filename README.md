...
| 1.4 | FAQ                              | Diego                       | Preguntas frecuentes y respuestas para resolver dudas comunes.                                                  | Media      |
| 1.5 | Contacto                         | Victor                      | Información de contacto para soporte adicional y consultas.                                                       | Fácil      |
| 2   | Inicio de sesión profesores      | Jonathan                    | Función para que los profesores inicien sesión en la plataforma.                                                 | Compleja   |
| 2.1 | Autenticación de dos factores     | Diego                       | Seguridad adicional mediante autenticación de dos factores para el inicio de sesión.                              | Alta       |
| 3   | Registro de profesores           | Jonathan                    | Proceso para registrar nuevos profesores en la plataforma.                                                        | Compleja   |
| 3.1 | Verificación de identidad        | Diego y Alexis              | Proceso para verificar la identidad de los profesores durante el registro.                                        | Alta       |
| 4   | Recuperar contraseña             | Diego, Victor, Alexis       | Función para recuperar contraseñas olvidadas o restablecer el acceso.                                            | Compleja   |
| 4.1 | Recuperación mediante email o SMS| Diego                       | Opción para recuperar contraseñas a través de correo electrónico o mensaje de texto.                             | Media      |
...
| 6.6 | Calificaciones y comentarios      | Diego                       | Permite a los alumnos ver y comentar sobre las calificaciones recibidas en actividades.                          | Media      |
...
| 8   | Análisis y reportes              | Diego y Victor              | Herramientas para generar reportes sobre el uso de la plataforma, el rendimiento de los alumnos y otros datos.     | Alta       |
...
| 9   | Integraciones                    | Diego                       | Funciones para integrar la plataforma con otras herramientas educativas y sistemas de gestión.                    | Alta       |
| 9.1 | Integración con herramientas de gestión de aprendizaje (LMS) | Diego | Integración con sistemas LMS para importar y exportar datos.                                                     | Alta       |
| 9.2 | Integración con plataformas de videoconferencia | Victor | Integración con herramientas como Zoom o Microsoft Teams para clases virtuales.                                  | Alta       |
...
| 11  | Seguridad y privacidad           | Diego y Victor              | Funciones para asegurar la privacidad y la seguridad de los datos de los usuarios.                                | Alta       |
| 11.1 | Políticas de privacidad           | Victor                      | Documentación sobre cómo se manejan y protegen los datos de los usuarios.                                        | Alta       |
| 11.2 | Gestión de permisos y accesos     | Diego                       | Configuración de permisos y accesos para garantizar que los usuarios sólo vean y editen la información que les corresponde. | Alta       |
